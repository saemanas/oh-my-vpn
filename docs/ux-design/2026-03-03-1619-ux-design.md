...
flowchart TD
    ...
    SelectProvider --> InputKey[API key input\n+ inline issuance guide link]
...
- Provider API key issuance guide delivered as **inline help link** on the API key input screen (not a separate step)
