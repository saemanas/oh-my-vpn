...
flowchart TD
    subgraph macOs["User's macOS Machine <i>[macOS 13+]</i>"]
        subgraph tauriApp["Oh My VPN.app <i>[Tauri Bundle]</i>"]
            ...
            preferencesStore["<b>Preferences Store</b><br/><i>[Rust]</i><br/>User settings persistence"]
        end
    ...
    class menuBarUi,tauriCore,providerManager,serverLifecycle,vpnManager,sessionTracker,keychainAdapter,preferencesStore appNode
